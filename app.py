...
# ----- NEW: define render_branch_loan_by_type BEFORE any calls -----
...
# Render the two loan-type-specific branch reports (Agrosor and CSL)
# Place these where the original Branch Wise Loan Disbursement was shown.
render_branch_loan_by_type(df, "SMART-Agrosor Loan", "SMART-Agrosor Loan")
st.markdown("---")
render_branch_loan_by_type(df, "SMART-CSL", "SMART-CSL")
st.markdown("---")

# Continue with remaining UI sections (Poultry, Grants, KPI, Average Ticket, Top 5, etc.)
